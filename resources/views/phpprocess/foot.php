<section class="footer-widget-wrapper">
		        ...
		        <div>
		          <div>
					<ul>
						...
						<li><a href="#">Blog</a>
							<ul>
								<li class="active"><a href="blog.html"><i class="fa fa-pencil-square-o"></i> Standard Blog</a></li>
	    ...
	    <!-- jQuery -->
		<script type="text/javascript" scr="css/jquery.js"></script>
		<script type="text/javascript" scr="css/jquery-ui.min.js"></script>
