...
?>
     ...
     <form id="form1" name="form1" method="post" action='course_search.php'>
	 ...
	 <form id="form2" name="form2" method="add" action='course_add.php'>
...
$sql=" Select * ";
  $sql=$sql." FROM course  ";
  $sql=$sql." where course_id   like  "."\"".$q_pro_id."\" ";
  $sql=$sql." and  course_name  like  "."\"".$q_pro_name."\"  "  ;
  $sql=$sql." order by course_id ";
}
										...
										<header class="entry-header">
											<div class="entry-meta">
									            <ul class="list-inline">
									                <li><span class="the-time"><a href="#"> <?PHP echo $result['course_id']; ?></a></span></li>

						         				</ul>
											</div><!-- /.entry-meta -->

											<h2 class="entry-title"><a href="blog-single.html"> <?PHP echo $result['course_name']; ?></a></h2>
										</header><!-- /.entry-header -->
										<div class="entry-content">
											<p><?PHP echo $result['course_des']; ?></p>
									    </div><!-- /.entry-content -->
										<div class="post-thumbnail">
											<img src="img/blog/blog-1.jpg" class="img-responsive " alt="">
										</div><!-- /.post-thumbnail -->
										<footer class="entry-footer">
                      <a href="register_coruse.php?course_id=<?PHP echo $result['course_id']; ?>"><input type="submit" method="get" value="ลงทะเบียน" class="btn btn-primary"></a>
 ...
 ?>
                	<nav class="pagination-wrap text-center">
										<ul class="pagination">
                                            ...
                                            <li>
                                                            <a href="course.php?page=1" aria-label="Previous">
                                                            <span aria-hidden="true">&laquo;</span>
                                                            </a>
                                             </li><?php for($i=1;$i<=$total_page;$i++){ ?>
                                                    <li><a href="course.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                                                    <?php } ?>
                                                         <li>

                                                         <li>
                                                            <a href="course.php?page=<?php echo $total_page;?>" aria-label="Next">
