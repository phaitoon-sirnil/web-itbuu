...
<center>
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tbody>
	     <tr>
	       <br><font color="black" size="15">เพิ่มข้อมูโครง/กิจกรรม</font></br> 
      </tr>
  </tbody></table>
  <br>
  
<form name="form1" method="post" enctype="multipart/form-data" action="event_insert.php">
...
//echo"<br>method-->$method<br> Txtcus_id-->$Txtcus_id<br>";
     ...
     $SQLfindnextcode="Select * FROM projectandevent order by pro_id DESC limit 1 "; 
